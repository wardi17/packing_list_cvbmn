      ...
      <div class="card-body">
        <div class="page-heading mb-3">
          <div class="page-title">
            <h6 class="text-start">Laporan Detail Final</h6>

            <!-- <h6>Hari : <span id="harikerja"></span></h6> -->
          </div>
        </div>
        <div id="filterdata" class="d-flex flex-wrap align-items-center gap-3 mb-3">
          <!-- From Date -->
          <div class="d-flex align-items-center">
            <label for="tgl_from" class="form-label me-2 mb-0">From</label>
            <input type="date" class="form-control" id="tgl_from" name="tgl_from" style="width: 150px;">
          </div>

          <!-- To Date -->
          <div class="d-flex align-items-center">
            <label for="tgl_to" class="form-label me-2 mb-0">To</label>
            <input type="date" class="form-control" id="tgl_to" name="tgl_to" style="width: 150px;">
          </div>

          <!-- Submit Button -->
          <button type="submit" name="submit" class="btn btn-primary" id="Createdata">
            Submit
          </button>
        </div>
...
<script>
  ...
  function getData(datas) {
    ...
    $.ajax({
      url: "<?= base_url ?>/laporankursfinal/listlaporan",
      data: datas,
      method: "POST",
      dataType: "json",
  ...
  function Set_Tabel(result) {
    ...
    $.each(result, function(a, b) {
      ...
      datatabel += `<td>
                                        <form id="frompacking" role="form" action="<?= base_url; ?>/laporankursfinal/cetakprint" method="POST" target="_blank" enctype="multipart/form-data">
