    ...
    $.each(result, function(a, b) {
      ...
      datatabel += `
                            ...
                            <td class="text-end">${b.Total}</td>
                             <td>${b.userid}</td>
                             <td>
                                <form id="frompacking" role="form" action="<?= base_url; ?>/transaksifinalkurs/posting" method="POST" enctype="multipart/form-data">
                            ...
                            <td>
                                    <form id="frompacking" role="form" action="<?= base_url; ?>/transaksifinalkurs/edit" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="NoPo" value="${b.NoPo}">
                                    <input type="hidden" name="supid" value="${b.supid}">
                                    <input type="hidden" name="No_Pli" value="${b.No_Pli}">
                                    <input type="hidden" name="No_Pls" value="${b.No_Pls}">
