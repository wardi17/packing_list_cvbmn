...
<script>
  ...
  function get_Data(datas) {
    ...
    $.ajax({
      url: "<?= base_url ?>/transaksifinalkurs/listdata",
      data: datas,
      method: "POST",
      dataType: "json",
    ...
    $.each(result, function(a, b) {
      ...
      datatabel += `
                            ...
                            <td class="text-end">${b.Total}</td>
                             <td>${b.userid}</td>
                            <td>
                                    <form id="frompacking" role="form" action="<?= base_url; ?>/transaksifinalkurs/tambah" method="POST" enctype="multipart/form-data">
