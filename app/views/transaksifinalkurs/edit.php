    ...
    <div class="card">
      <div class="card-header">
        <div class="row col-md-12">
          <div class="col-md-1">
            <button id="kembalilist" type="button" class="btn btn-lg text-start"><i class="fa-solid fa-chevron-left"></i></button>
          </div>
          <div class="col-md-11">
            <h5 class="text-center">Edit Final Data</h5>
          </div>
        </div>
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-12 mb-2">
              ...
              <div  class="row mb-12 mb-2">
                ...
                <div class=" col-sm-6">
                  <input  class="form-control" id="namaproduk" value="<?= $datapost["NamaProduk"] ?>">
