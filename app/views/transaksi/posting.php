...
<div id="main">
  ...
  function  getTampilDetailPO(datas){
      $.ajax({
        url:"<?=base_url?>/transaksi/tampildetailposting",
                method:"POST",
                dataType: "json",
                data:datas,
        success:function(result){
  ...
  function getListItem(){
     const item =`<div class="card mt-2">
      ...
      <button type="btn"  onclick="Submitdata()"; class="btn btn-primary">Posting</button>
  ...
  function setData(result){
    ...
    // $("#delete").fadeIn();
    // $("#loadingModal").hide();
    const total_kom = result.TotalKomp;
                 ...
                 <table id="tabel1" class='table table-info table-striped table-bordered  table-hover' style='width:100%'>                    
                                      <thead  id='thead'class ='thead'>
                                                <tr>
                                                            ...
                                                            <th  class="text-end">Komposisi %</th>
    ...
    $.each(Detail,function(a,b){
      ...
      datatabel +=`<td class="text-end"style="width:10%">${b.Komposisi}</td>`;
    ...
    datatabel+=`</tbody><tfoot>
              ...
              <th class="text-end" id="total_komp">${total_kom}</th>
                     `; 
    ...
    const total = $("#total").text();
     ...
     if(total !==""){
      ...
      const forwarder = $("#forwarder").val();
       ...
       $.ajax({
              url:"<?=base_url?>/transaksi/simpanposting",
                method:"POST",
                dataType: "json",
                data:datafull,
                beforeSend: function(){
