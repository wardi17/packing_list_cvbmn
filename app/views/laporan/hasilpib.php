...
<div class ="col-md-12 col-12">
        <div class="card">
            ...
            <div  class="page-heading mb-3">
                  <div class="page-title">
                   <h6 class="text-start">Laporan Hasil PIB</h6>
  ...
  <script>
    ...
    function  getData(datas){
      ...
      $.ajax({
                  url:"<?=base_url?>/laporan/listlaporanhasilpib",
                  data:datas,
                  method:"POST",
                  dataType: "json",
        ...
        let no =1;
              $.each(result,function(a,b){
                ...
                datatabel +=`
                  ...
                  datatabel +=`<td>
                                        <form id="frompacking" role="form" action="<?= base_url; ?>/laporan/cetakprinthasilpib" method="POST" target="_blank" enctype="multipart/form-data">
