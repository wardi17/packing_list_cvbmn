...
export default class TransakiForwoderFinal_Posting{
    ...
    getDataForwarder(){
        ...
        $.ajax({
            ...
            headers: { 'url': 'msfor/tampilforwadereditfinal' },
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTableeditLabel">Detail Forwader</h5>
