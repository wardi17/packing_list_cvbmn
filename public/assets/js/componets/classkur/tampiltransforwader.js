...
export default class TransaksiForwarder {
    ...
    getDataForwarder(){
        $.ajax({
            ...
            headers: { 'url': 'msfor/tampilforwader' },
  ...
  setModalData(result) {
    ...
    modal.id = "modaltransforwader";
    modal.tabIndex = -1;
    modal.setAttribute("data-bs-backdrop", "static");
    modal.setAttribute("data-bs-keyboard", "false");
    modal.setAttribute("aria-labelledby", "modaltransforwaderLabel");
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" id="tambahforwader">Tambah</button>
                    </div>
                </div>
            </div>
        </div>`;
    this.container.appendChild(modal);
     ...
     const modalInstance = new bootstrap.Modal(document.getElementById('modaltransforwader'));
    modalInstance.show();
